...
export function ResidentProgress({ onBack, onNavigateToResident }: ResidentProgressProps) {
  const residents = [
    ...
    { name: 'Margaret Liu', unit: 'Room 204', sessions: 6, skills: 12, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    { name: 'Robert Kim', unit: 'Room 312', sessions: 8, skills: 15, lastAttended: 'Nov 20', plan: 'Premium ($149/mo)' },
    { name: 'Helen Martinez', unit: 'Room 108', sessions: 5, skills: 9, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    ...
    { name: 'George Nakamura', unit: 'Room 325', sessions: 4, skills: 8, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    { name: 'Betty Yamamoto', unit: 'Room 209', sessions: 6, skills: 11, lastAttended: 'Nov 20', plan: 'Standard ($79/mo)' },
    { name: 'Thomas Park', unit: 'Room 418', sessions: 5, skills: 10, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    ...
    { name: 'Mary Johnson', unit: 'Room 401', sessions: 10, skills: 18, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    ...
    { name: 'Susan Lee', unit: 'Room 289', sessions: 5, skills: 9, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    ...
    { name: 'Steven Park', unit: 'Room 367', sessions: 4, skills: 7, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    ...
    { name: 'Ruth Nakamura', unit: 'Room 134', sessions: 5, skills: 10, lastAttended: 'Nov 20', plan: 'Facility Subscription' },
    ...
    { name: 'David Rodriguez', unit: 'Room 145', sessions: 5, skills: 9, lastAttended: 'Nov 18', plan: 'Facility Subscription' },
    ...
    { name: 'Christopher Chen', unit: 'Room 378', sessions: 5, skills: 10, lastAttended: 'Nov 15', plan: 'Facility Subscription' },
    { name: 'Karen Nakamura', unit: 'Room 212', sessions: 6, skills: 11, lastAttended: 'Nov 18', plan: 'Basic ($39/mo)' },
    { name: 'Matthew Park', unit: 'Room 345', sessions: 4, skills: 8, lastAttended: 'Nov 18', plan: 'Facility Subscription' },
    ...
    { name: 'Amanda Kato', unit: 'Room 412', sessions: 4, skills: 7, lastAttended: 'Nov 15', plan: 'Facility Subscription' },
